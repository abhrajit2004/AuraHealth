    ...
    <header className="sticky top-0 z-10 flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 text-blue-900 md:mx-auto md:flex-row md:items-center">
      ...
      >
        <span className="mr-2 text-4xl text-blue-500">
          <img src="/ambulance.png" alt="Aurahealth Logo" width={100} height={100} />
          {/* <svg
            ...
            <>
              ...
              <li className="md:mr-12">
                <button 
                  ...
                  className="rounded-full border-2 border-red-600 px-6 py-1 text-red-600 transition-colors hover:bg-red-600 hover:text-white"
                >
                  Logout
                </button>
              </li>
